...
//		pane1.setStyle("-fx-background-image: url('application/logo.png')");
//		pane2.setStyle("-fx-background-image: url('application/ssbu.jpg')");
//		pane3.setStyle("-fx-background-image: url('application/ink.jpg')");
//		pane4.setStyle("-fx-background-image: url('application/kkr.jpg')");
